...
- **TYYPPI 2 — Intervalli** [joka N] × [tuntia / päivää / viikkoa / kuukautta]: kattaa "joka 4. päivä", "joka 3. viikko", "joka 2. tunti". Huom tunti-taso mukana (eri aikaskaala kuin päivä/viikko).
...
### 4.9 WILMA-POIMINTA (konsepti muistiinpanoissa — tiivistys)

Koulun Wilma-viestit ovat perheen suurin yksittäinen "asioita hukkuu" -lähde. Konsepti: viestin sisältö liimataan/jaetaan appiin → äly poimii toimenpiteet (päivämäärät, maksut, varusteet, luvat) → ehdokkaina oikeisiin paikkoihin (muistutus, Kauppalista, kalenteri-info). Sama kolmiporras, sama äly-putki. Rakennetaan kun arki sitä vaatii (koulu alkaa elokuussa).
