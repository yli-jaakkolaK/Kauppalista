...
- **5. Laiturin murujen kevyt korjausmuokkaus:** napautus murun tekstiin avaisi inline-muokkauksen (sama ele kuin kaikkialla muualla) — KOROSTETUSTI korjaava ei jalostava käyttötapaus (esim. "sodastreamin kaasupullon täyttö" täsmennys "täytetty [pvm]"). Kytkökset päätettävä: muokkaus nollaisi älyn käsittelymerkinnän (`aly_evaluated.content`, sql/044) ja päivittyisi aktiiviseen nostoon jos muru on ankkuroitu (yksi totuus).
