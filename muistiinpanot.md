...
Jos joudut päättämään mistä jatkat: aja ensin PALUU.md:n VAIHE 1 -testit läpi (täppäys Satama-listalta), sitten torstaina VAIHE 2 Juhan kanssa, sitten E3-keskiportaan OSA O ja Rivien UI-remontin OSA P viimeisinä, ja vasta sen jälkeen aloita ristiriitapaketti.
