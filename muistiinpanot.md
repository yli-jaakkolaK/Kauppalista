...
- **7. Aikavalitsin: rulla + suora syöttö + KELLONAIKA-tila (laajennettu KIILAN yhteydessä 2026-07-14):** kaksi syöttötilaa samaan jaettuun komponenttiin — PIKA (nykyiset suhteelliset pikanapit, hyvä pikatarpeille) ja KELLONAIKA (päivävalinta tänään/huomenna/pvm + kellonaika rullalla/suoralla syötöllä — arjen muistutukset ajatellaan kellonaikoina, ei minuuttilaskuina: "huomenna klo 9" ei saisi vaatia päässälaskua 22:47:stä). Sama komponentti kaikkiin ⏰-paikkoihin (rivi/kalenteri/ankkuri).
- **8. Täppäys/poisto × elävät muistutukset:** rivin täppäys tehdyksi tai poisto ei käsittele elävää muistutusta mitenkään tällä hetkellä (paitsi Laituri/Muistilaput-poisto, jotka jo puhdistavat) — pörinä kadonneesta/hoidetusta asiasta opettaa ohittamaan hälytykset. Korjaus: näkyvä ilmoitus/kysymys ("myös N muistutusta poistettu [Kumoa]").
- **9. Laiturin "Sijoita…" käsikohdevalinta:** ⋯-valikkoon (tai vastaavaan) käsin valittava sijoituskohde (kaikki listat + hytti) ilman älyä — käsipolku ensisijainen, ✨ pysyy oikotienä.
- **10. ✨-promptidiagnoosi (kalenterifiksaatio):** vaikka "kalenteriin" on jo poistettu kohdevalikoimasta (ks. "Kalenteri-sijoitus ei kirjoita mitään"), alkuperäinen oire (äly ehdotti kalenteria aikamäärettömälle ostosmurulle) kannattaa silti diagnosoida: lokita KOKO lähetetty prompti kerran, lisää kohteille luonnehdinnat pelkkien nimien sijaan, varmista ettei yöajon prompti sekoitu ✨-napin promptiin.
- **11. Konsepti "Tiivistä sovitut":** iso tekstikenttä + iOS-natiivisanelu → äly poimii sovitut asiat (päätökset/pvm:t/vastuut) → tiivistelmä Hyttiin. Käyttöhetki JÄLKIKÄTEEN (purkusanelu, ei keskustelun aikana — läsnäolotyön etiikka). Sama moottori kuin "Tuo viesti". Yksityisyys: raakateksti käsitellään ja unohdetaan heti.
- **12. Design-periaate "Sama appi molemmille — syvyys tarjolla, ei tyrkyllä":** kaksi mitoituskäyttäjää (teho + minimalisti), kerroksellisuus, pohjakerros ilman opeteltavaa, syvemmät toiminnot eivät pakota itseään esiin, pallurat yhteisenä kielenä molemmille.
- **13. Kirjoituskäytäntö sanastoon:** merkintämurut menneessä aikamuodossa ("täytetty 15.7."), tehtävät preesensissä ("täytä") — muru kantaa aikamuotonsa itse, ei tarvitse erillistä kenttää.
