...
const ALAPALKKI_IKONIT = {
  ...
  // Muistilaput-kuvake: kokeiltu spiraalimuistilehtiötä (🗒️), rastitettua
  // valintaruutua (☑️) ja käsinpiirrettyä leikepöytä+rasti-SVG:tä sinapilla
  // (2026-08-30) — Katri halusi lopulta AIDON emojin, ei käsinpiirrettyä
  // versiota, vaikka emoji ei tottele CSS-väriä (ks. muisti
  // feedback_emoji_ignores_css_color, ei korjattavissa ilman käsinpiirtoa
  // jota Katri ei halunnut). Päädytty leikepöytäemojiin sellaisenaan.
...
// piirraOpintoKurssinYhteysLinkit() ja piirraOpintoKurssinYhteysalueet()
// siirretty omaan tiedostoonsa (opinto-miro.js, 2026-08-30, script.js:n
// pilkkomisen askel 4, ks. muistin project_scriptjs_split_plan).
...
// avaaHarjoittele() siirretty omaan tiedostoonsa (harjoittele.js,
// 2026-08-30, script.js:n pilkkomisen ensimmäinen askel, ks. muistin
// project_scriptjs_split_plan) — kutsutaan yllä olevasta Harjoittele-
// napista, muokkaa harjoittele.js:ää jos tarve.
...
// === TEKOÄLYKEHOTE (SATAMA_SPEKSI.md §7.6, "harjoitustehtävien kolmas
// lähde": kurssin omat tehtävät -> ulkoiset lähteet -> Sataman koostama
// kopioitava prompti ulkoiselle tekoälylle. Ei API-kutsua, ei maksa
// mitään — spec sanoi tämän olevan rivi kannassa per (tyyppi, vaihe);
// rakennettu tässä JS-funktiona saman lopputuloksen, koska koko
// promptipohja-sisältö täytyi joka tapauksessa kirjoittaa nyt ensimmäistä
// kertaa eikä yksittäisten rivien muokkaus vaadi tietokantaa — helpompi
// säätää suoraan koodista Katrin palautteen mukaan. Siirto omaksi
// tauluksi on mahdollista myöhemmin ilman rakennemuutosta jos tarve tulee.
//
...
// paivitaOpintoTehtavaMiroKoukku() siirretty omaan tiedostoonsa
...
// FÖLI (pysäkkihaku, SIRI-lähdöt, tunnetut matkat, haeFoliSiirtymatTapahtumalle
// ym.) siirretty omaan tiedostoonsa (foli.js, 2026-08-30, script.js:n
// pilkkomisen askel 3, ks. muistin project_scriptjs_split_plan) — kutsutaan
// yllä kuormatasolaskennassa ja alempana päivänäkymän siirtymäpalikoissa,
// muokkaa foli.js:ää jos tarve.
